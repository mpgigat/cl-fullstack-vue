        ...
        <v-flex text-xs-center>
          <v-card flat tile color="primary" class="white--text">
            <v-card-text class="white--text pt-0">
              Adsi Centro Agroturistico &copy;2021
            </v-card-text>
          </v-card>
        </v-flex>
      </v-layout>
...
export default {
  ...
  computed:{
    ...
    esAlmacenista(){      
      return this.$store.state.usuario && this.$store.state.usuario.rol == 'ALMACENISTA_ROL';
    },
    esVendedor(){
      return this.$store.state.usuario && this.$store.state.usuario.rol == 'VENDEDOR_ROL';
    }
  },
  created(){
